<?php
define('admin_email','you@domain.com'); // Change admin email here for example admin@yoursite.com
define('website_name','AnyPurpose'); // Change website name here for example yoursite.com
